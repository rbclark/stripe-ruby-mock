  ...
  module RequestHandlers
    module Helpers
      ...
      def custom_subscription_params(plans, cus, options = {})
        ...
        keys_to_merge = /application_fee_percent|quantity|metadata|tax_percent|collection_method|days_until_due|default_tax_rates|pending_invoice_item_interval|default_payment_method|collection_method/
